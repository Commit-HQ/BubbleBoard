...
The photos step then holds two things. The photos already up come first: each with its own words, which can be rewritten, and one way to take it off, which asks first, because families will stop seeing it and anyone who already saved it keeps their copy. They are never opened in the cover editor again — their covers and the consent behind them belong to the day they were published, and reopening them would mean sealing them under today's answers. Photos added now sit below them and go through the whole of the editor exactly as they do for a new event: detection, covers, child assignment and review, against the consent as it stands today. The review step therefore shows only the photos being added; a change that adds none goes straight to the line that saves it, which says "Save changes" rather than "Publish event". An event must keep at least one photo, and saving says so while it holds none.
