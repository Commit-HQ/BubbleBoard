...
> - **Private inquiries (2026-09-18):** titled, family-private conversations are implemented ahead of classroom photos. Per-classroom admin settings control parent sending (on/off and weekday hours) and the monthly number of family-initiated inquiries. Replies and teacher-initiated inquiries are free; teachers close conversations. See the README’s Private inquiries section for the implemented behavior.
