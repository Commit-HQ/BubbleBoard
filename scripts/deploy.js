...
// or the notifications queue also writes them into wrangler.jsonc. Later deploys find them by name, so the
// file goes back to how it was, the same for every installation, however the deploy ends.
